...
void setup() {
  ...
  Alarm.alarmRepeat(0,37,0, AlarmON); 
  Alarm.alarmRepeat(9,50,0, AlarmON2);
  Alarm.alarmRepeat(10,0,0, AlarmON);
  Alarm.alarmRepeat(10,10,0, AlarmON);
  Alarm.alarmRepeat(12,0,0, AlarmON);
  Alarm.alarmRepeat(12,40,0, AlarmON);
  Alarm.alarmRepeat(14,50,0, AlarmON2);
  Alarm.alarmRepeat(15,0,0, AlarmON);
  Alarm.alarmRepeat(15,10,0, AlarmON);
